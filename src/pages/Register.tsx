    ...
    <AuthLayout>
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-white/40 text-sm mt-1">Start your journey with us</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            {formData.password && (
              <div className="space-y-1">
                ...
                <p className="text-xs text-white/50">{passwordStrength.label}</p>
              </div>
            )}
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-4 bg-[#0d0d0d]/80 text-white/30 backdrop-blur-sm">Or sign up with</span>
          </div>
        </div>
        ...
        <p className="text-center text-white/40 text-sm">
          ...
          <Link to="/login" className="text-pink-400/90 hover:text-pink-400 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
